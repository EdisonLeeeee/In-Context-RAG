...
datasets=('Cora' 'Pubmed' 'History' 'Children' 'Photo' 'Computers' 'Arxiv' 'Fitness')  # List of datasets
gpu_ids="0,1,2,3,4,5,6,7"  # Specified GPU IDs, separated by commas
...
output_base_dir="node_results"
input_dir="node_prompts"
